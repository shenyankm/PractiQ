...
Product CRUD, task persistence and single-user rules now belong to the Python FastAPI package in `../backend/`. Keep this AI package private and preserve per-call usage and semantic-only DTOs.
