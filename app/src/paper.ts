...
export function types(): Record<string,string> { return {single:t("单选"),multiple:t("多选"),true_false:t("判断"),fill_blank:t("填空"),short_answer:t("简答"),ordering:t("排序"),matching:t("匹配"),reading:t("阅读理解"),word_bank:t("选词填空"),cloze:t("完形填空")}; }
