...
Question drafts may contain missing business fields. See [completeness and migration 003](../docs/question-completeness.md) for the read-only `missingFields` contract and existing-database upgrade.
