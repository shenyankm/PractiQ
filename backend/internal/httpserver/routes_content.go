...
func registerContentRoutes(router *http.ServeMux, handlers ContentHandlers) {
	registerMethodRoute(router, http.MethodGet, "/api/v1/banks", handlers.Banks)
	registerMethodRoute(router, http.MethodPost, "/api/v1/banks", handlers.Banks)
