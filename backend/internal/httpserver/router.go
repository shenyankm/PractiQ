...
func NewServer(cfg ServerConfig, deps ServerDependencies) http.Handler {
	...
	registerMethodRoute(router, http.MethodPost, "/api/v1/auth/email-code", deps.Auth.EmailCode)
	registerMethodRoute(router, http.MethodGet, "/api/v1/auth/google/start", deps.Auth.GoogleStart)
	registerMethodRoute(router, http.MethodGet, "/api/v1/auth/google/callback", deps.Auth.GoogleCallback)
	registerMethodRoute(router, http.MethodPost, "/api/v1/auth/google/token", deps.Auth.GoogleToken)
